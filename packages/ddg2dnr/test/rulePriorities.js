...
describe('Rule Priorities', () => {
    it('should have an up to date overview of all rule priorities', () => {
        ...
        assert.equal(AD_ATTRIBUTION_POLICY_PRIORITY, 35000)
        ...
        assert.equal(TRACKING_PARAM_PRIORITY, 35000)
    ...
    it('should have the correct relative rule priorities', () => {
        ...
        assert.ok(AD_ATTRIBUTION_POLICY_PRIORITY > CONTENT_BLOCKING_ALLOWLIST_PRIORITY)
        ...
        assert.equal(AD_ATTRIBUTION_POLICY_PRIORITY, TRACKING_PARAM_PRIORITY)
        ...
        assert.ok(TRACKING_PARAM_PRIORITY < AMP_PROTECTION_PRIORITY)
        assert.ok(TRACKING_PARAM_PRIORITY < GPC_HEADER_PRIORITY)
