 ...
 * @property {string[] | null} [requestDomains]
 * @property {string[] | null} [excludedRequestDomains]
 * @property {string[] | null} [initiatorDomains]
 * @property {string[] | null} [excludedInitiatorDomains]
