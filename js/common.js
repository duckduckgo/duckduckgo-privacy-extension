...
var DuckDuckBox = function(inputName, forbiddenIDs, contentDiv, hover) {
    ...
    if (document.getElementsByName(this.inputName).length > 0)
        this.lastQuery = document.getElementsByName(this.inputName)[0].value;
    else
        this.lastQuery = '';
};
...
DuckDuckBox.prototype = {
    ...
    renderZeroClick: function(res, query) {
        ...
        for(var i in this.forbiddenIDs) {
            if (document.getElementById(this.forbiddenIDs[i]) !== null)
                return;           
        }
    ...
    createResultDiv: function() {
        var result = document.getElementById(this.contentDiv);
        var ddg_result = document.getElementById("ddg_zeroclick");
        this.showZeroClick();
    ...
    resultsLoaded: function() {
        if(options.dev)
            console.log(document.getElementById(this.contentDiv), document.getElementById(this.contentDiv).style.visibility);
        
        if (document.getElementById(this.contentDiv) !== null){
            if (document.getElementById(this.contentDiv).style.visibility === "visible" ||
