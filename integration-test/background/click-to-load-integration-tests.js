...
const testSite = 'http://fingerprinttest.com:3000/privacy-protections/click-to-load/'
let browser
let bgPage
...
describe('Test Click To Load', () => {
    ...
    it('CTL: Should block FB requests by default', async () => {
        ...
        try {
            ...
            // give it another second just to be sure (facebook widgets can take time to load)
