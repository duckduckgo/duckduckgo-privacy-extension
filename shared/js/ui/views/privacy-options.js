...
PrivacyOptions.prototype = window.$.extend({},
    Parent.prototype,
    {
        ...
        setup: function () {
            this._cacheElems('.js-options', ['blocktrackers', 'https-everywhere-enabled', 'embedded-tweets-enabled', 'gpc-enabled', 'youtube-previews-enabled', 'firebutton-history-enabled', 'firebutton-tabclear-enabled'])
            this.bindEvents([
                ...
                [this.$firebuttonhistoryenabled, 'click', this._clickSetting],
