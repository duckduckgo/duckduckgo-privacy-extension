    ...
    <ul class="default-list">
        ...
        <li class="site-info__li--manage-whitelist padded border--bottom">
            <div class="js-site-confirm-breakage site-info--confirm-breakage padded border--bottom is-hidden">
                ...
                <a href="javascript:void(0)" class="js-site-confirm-breakage-yes site-info__confirm-breakage-yes btn-pill">
                    Yes
                </a>
                <a href="javascript:void(0)" class="js-site-confirm-breakage-no site-info__confirm-breakage-no btn-pill">
                    No
                </a>
            </div>
