...
module.exports = function () {
  return bel`<nav class="hamburger-menu js-hamburger-menu is-hidden">
    ...
    <div class="hamburger-menu__content card padded">
      ...
      <li>
          <a href="${getSafariOptionsHref()}" class="menu-title js-hamburger-menu-options-link">
        Settings
...
function getSafariOptionsHref () {
    return safari.extension.baseURI + 'html/options.html'
}
