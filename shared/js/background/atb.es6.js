...
export const addParametersMainFrameRequestUrl = ATB.addParametersMainFrameRequestUrl
export const getSurveyURL = ATB.getSurveyURL
export const updateSetAtb = ATB.updateSetAtb
export const shouldUpdateSetAtb = ATB.shouldUpdateSetAtb
export const openPostInstallPage = ATB.openPostInstallPage
export const updateATBValues = ATB.updateATBValues
export const getAcceptedParamsFromURL = ATB.getAcceptedParamsFromURL
export const setInitialVersions = ATB.setInitialVersions
export const canShowPostInstall = ATB.canShowPostInstall
