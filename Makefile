...
CONTENT_SCOPE_SCRIPTS_TRACKER_LOOKUP_DEPS =
ifneq ("$(wildcard $(CONTENT_SCOPE_SCRIPTS)/.git/)","")
  ...
  CONTENT_SCOPE_SCRIPTS_DEPS += $(CONTENT_SCOPE_SCRIPTS)/build/tracker-lookup.json
  ...
  CONTENT_SCOPE_SCRIPTS_TRACKER_LOOKUP_DEPS += $(CONTENT_SCOPE_SCRIPTS)/package.json
  CONTENT_SCOPE_SCRIPTS_TRACKER_LOOKUP_DEPS += $(CONTENT_SCOPE_SCRIPTS)/scripts/bundleTrackers.mjs
endif
...
$(CONTENT_SCOPE_SCRIPTS)/build/tracker-lookup.json: $(CONTENT_SCOPE_SCRIPTS_TRACKER_LOOKUP_DEPS)
	cd $(CONTENT_SCOPE_SCRIPTS); npm run bundle-trackers
